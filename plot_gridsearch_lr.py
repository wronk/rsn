...
file_name = 'lr_scores_2016_10_26__11_56.pkl'
...
fig1, axes1 = plt.subplots(cls_shape[0], cls_shape[1], figsize=(14, 6),
...
for ind_2d in list(product(*[range(cls_shape[0]), range(cls_shape[1])])):
    ...
    axes1[ind_2d].set_xticklabels(hyp_p[1])

    axes1[ind_2d].set_yticks(range(cls_shape[2]))
    axes1[ind_2d].set_yticklabels(hyp_p[0])

    # Set batch
    if ind_2d[0] == 0:
        title = 'Batch size: %i' % hyp_p[2][ind_2d[1]]
