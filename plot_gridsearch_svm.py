"""
plot_gridsearch_svm.py

author: @wronk

Plots saved SVM gridsearch data
"""
...
#file_name = 'svm_scores_2016_11_16__00_42%s.pkl' % shuffled_add
file_name = 'svm_scores_2016_11_17__17_11%s.pkl' % shuffled_add
...
fig1, axes1 = plt.subplots(1, cls_shape[0], figsize=(16, 6), sharey=True)
...
ax2.set_xlabel('gamma val')
ax2.set_ylabel('C val')


# Adjust spacing and add colorbar
fig2.tight_layout(pad=4)
cax2 = fig2.add_axes([0.85, 0.2, 0.02, 0.6])
...
###################
if save_plot:
    save_fname_1 = op.join(saved_data_dir, 'svm_gridsearch',
                           'svm_plot_%02i_subjs_%s%s' % (cls_shape[0],
                                                         result_dict['time_finished'],
                                                         shuffled_add))
    save_fname_2 = op.join(saved_data_dir, 'svm_gridsearch',
                           'svm_plot_%02i_subjs_avg_%s%s' % (cls_shape[0],
                                                             result_dict['time_finished'],
                                                             shuffled_add))
